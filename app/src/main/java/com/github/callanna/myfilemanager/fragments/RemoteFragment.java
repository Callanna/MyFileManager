...
import com.github.callanna.myfilemanager.activities.ServerControlActivity;
import com.github.callanna.myfilemanager.services.FTPServerService;
import com.github.callanna.myfilemanager.swiftp.Defaults;
import com.github.callanna.myfilemanager.swiftp.Globals;
import com.github.callanna.myfilemanager.swiftp.MyLog;
import com.github.callanna.myfilemanager.swiftp.UiUpdater;

import java.io.File;
import java.net.InetAddress;

/**
 * Created by Callanna on 2015/12/13.
 */
public class RemoteFragment  extends Fragment implements ServerControlActivity.IBackPressedListener {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 0: // We are being told to do a UI update
                    ...
                    // do one.
                    Log.d("RemoteFragment","duanyl=====>已经UpdateUI");
                    removeMessages(0);
                    updateUi();
                    break;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mRootView = inflater.inflate(R.layout.server_control_fragment, container, false);
    ...
    View.OnClickListener startStopListener = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            Log.d("RemoteFragment", "duanyl=======>0");
            //File chrootDir = new File(Environment.getExternalStorageDirectory().getAbsolutePath());
            File chrootDir = new File(Environment.getRootDirectory().getAbsolutePath());
