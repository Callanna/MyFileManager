...
package com.github.callanna.myfilemanager.services;
...
import com.github.callanna.myfilemanager.swiftp.ProxyConnector;
import com.github.callanna.myfilemanager.swiftp.SessionThread;
import com.github.callanna.myfilemanager.swiftp.TcpListener;
import com.github.callanna.myfilemanager.swiftp.UiUpdater;
import com.github.callanna.myfilemanager.swiftp.Util;
...
public class FTPServerService extends Service  {
    ...
    public void onCreate() {
        ...
        Log.d("Service", "duanyl=======>SwiFTP server created");
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        serverThread = new Thread(serverrunable);
        serverThread.start();
        return super.onStartCommand(intent, flags, startId);
    }
     public Runnable serverrunable = new Runnable() {
         @Override
         public void run() {
             ...
             Log.d("FTPServerService", "duanyl=====>已经UpdateUI  1") ;
            ...
            //  setupNotification();
             ...
             // can present the URL
             UiUpdater.updateClients();
             Log.d("FTPServerService", "duanyl=====>已经UpdateUI  2") ;
             while (!shouldExit) {
                 if (acceptWifi) {
